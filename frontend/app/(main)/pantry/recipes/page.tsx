...
interface RecipesResponse {
  ...
  recommendationsLimit?: string;
}

export default function PantryRecipesPage(): JSX.Element {
  const {
    loading,
    data: recipesData,
    fn: fetchSuggestions,
  } = useFetch<any>(getRecipesByPantryIngredients );
  ...
  const ingredientsUsed: string = recipesData?.ingredientsUsed || "";
